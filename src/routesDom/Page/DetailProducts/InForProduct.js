                        ...
                        <div className="information-detail">
                            ...
                            <div className="group-description-more">
                                <div className="description-more-info">
                                    ...
                                    <p>
                                        mã sản phẩm:{" "}
                                        <span>{dataProductsId._id}</span>
                                    </p>
                                    <p>
                                        nhà xản xuất:{" "}
                                        <span>{dataProductsId.key}</span>
                                    </p>
                                    <p>
                                        bộ sưu tập:{" "}
                                        <span>
                                            {dataProductsId.collections}
                                        </span>
                                    </p>
                                    <p>
                                        loại sản phẩm:{" "}
                                        <span>
                                            {dataProductsId.productType}
                                        </span>
                                    </p>
                                    <p>
                                        dòng sản phẩm:{" "}
                                        <span>{dataProductsId.NSX}</span>
                                    </p>
                                    <p>
                                        màu sắc:{" "}
                                        {dataProductsId.color.map(
                                            (color, index) => (
                            ...
                            <div className="group-free-detail">
                                ...
                                <p>
                                    Miễn phí giao hàng (tối đa 30k) cho đơn hàng
                                    từ 900k Xem chi tiết
                                </p>
                            </div>
                            <Form
                                form={form}
