            ...
            <div className="group-info-buy-cart">
                ...
                <div className="button-more-info">
                    ...
                    {cart.status_order && (
                        ...
                        >
                            ...
                            Trạng Thái:{" "}
                            {!cart.success ? "Chờ Phê Duyệt" : "Đã Phê Duyệt"}
                        </Button>
                    )}
                    <Button
                        type="primary"
                ...
                <div className="ground-address-cart">
                    ...
                    <div className="group-time-modal">
                        ...
                        <p>
                            {`${moment(cart.timeCart).fromNow()}, ${moment(
                                cart.timeCart
                            ).format("LLLL")}`}
                        </p>
                    </div>
            ...
            >
                <Form.Item name="message">
                    <TextArea
                        ...
                        id="message"
                    />
                    <p className="length-content-message">
                        {contentMessage.length}/100
                    </p>
                </Form.Item>
            </Modal>
        </>
