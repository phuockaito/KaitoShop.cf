...
export default function UserManage() {
    ...
    const actionGetListCommentsUser = (params, token) =>
        dispatch(getListCommentsUser(params, token));
    const actionGetListCartUser = (params, token) =>
        dispatch(getListCartUser(params, token));
    const actionDeleteCommentUser = (params, token) =>
        dispatch(deleteCommentUser(params, token));
    const actionDeleteAccountUser = (params, token) =>
        dispatch(deleteAccountUser(params, token));
    const actionPostActiveRoleUser = (id_user, token) =>
        dispatch(postActiveRoleUser(id_user, token));
    // create state
