        ...
        try {
            if (values) {
                    ...
                    if (fileListImage.length < 4) {
                        ...
                        for (
                            ...
                            if (element.uid) {
                                formData.append(
                                    "poster",
                                    fileListImage[index].originFileObj
                                );
                            }
                            if (element.url) {
                        ...
                        const resultProduct = await actionUpdateProduct(
                            formData,
                            token
                        );
                ...
                if (!id_product) {
                    ...
                    // Check Api Request
                    const resultProduct = await actionPostAddProduct(
                        formData,
                        token
                    );
                    const resProduct = unwrapResult(resultProduct);
    ...
    return (
        <>
            {linkNewProduct && (
                <h4>
                    {" "}
                    Click xem sản phẩm vừa {id_product
                        ? "cập nhật"
                        : "thêm"}{" "}
            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: "Vui lòng nhập bộ sưu tập !",
                        },
                    ]}
                >
                    <TextArea rows={2} maxLength={100} />
