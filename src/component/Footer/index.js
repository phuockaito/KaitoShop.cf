                ...
                <div className="group-footer">
                    <div className="footer">
                        ...
                        <div className="group-connect-us">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/PhuocKaito1410" target="_blank" rel="noopener noreferrer"><i className="fa fa-facebook" /></a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/phuockaito" target="_blank" rel="noopener noreferrer"><i className="fa fa-twitter" /></a>
                                </li>
                                <li>
